...
(function (viewer) {
    var CanvasRender = /** @class */ (function () {
        ...
        CanvasRender.prototype.doRender = function (logo, canvas, show_names, scale) {
            ...
            metrics = new viewer.LogoMetrics(ctx, logo.columns, logo.rows, draw_name);
            ...
            if (typeof this.raster_scale === "number" &&
                ...
                raster = new viewer.RasterizedAlphabet(logo.alphabet, metrics.stack_font, metrics.stack_width * scale * 2);
    ...
    */
    var LoadQueryTask = /** @class */ (function () {
        ...
        LoadQueryTask.prototype.logo_1 = function (alphabet, fine_text, pspm) {
            "use strict";
            return new viewer.Logo(alphabet, fine_text).addPspm(pspm);
        };
        /**
    ...
    viewer.LoadQueryTask = LoadQueryTask;
})(viewer || (viewer = {}));
var viewer;
(function (viewer) {
    var MotifLogo = /** @class */ (function () {
        function MotifLogo() {
            this.task_queue = [];
            this.task_delay = 100;
            this.draw_logo_on_canvas = new viewer.CanvasRender(this);
        }
        /**
        ...
        */
        MotifLogo.prototype.drawLogo = function (div_id, pwm, scale) {
            ...
            new viewer.LoadQueryTask(div_id, pwm, scale, this).run();
        };
        /**
        ...
        */
        ...
        MotifLogo.prototype.size_logo_on_canvas = function (logo, canvas, show_names, scale) {
            ...
            if (canvas.width !== 0 && canvas.height !== 0) {
                ...
                metrics = new viewer.LogoMetrics(canvas.getContext('2d'), logo.columns, logo.rows, draw_name);
            }
            if (typeof scale == "number") {
                //resize the canvas to fit the scaled logo
                canvas.width = metrics.summed_width * scale;
...
(function (viewer) {
    ...
    })(AlphabetColors = viewer.AlphabetColors || (viewer.AlphabetColors = {}));
})(viewer || (viewer = {}));
var viewer;
(function (viewer) {
    ...
    */
    var LogoMetrics = /** @class */ (function () {
        function LogoMetrics(ctx, logo_columns, logo_rows, allow_space_for_names) {
            ...
            this.name_font = "bold ".concat(this.name_height, "px Times, sans-serif");
            this.y_label = "bits";
            this.y_label_font = "bold ".concat(this.y_label_height, "px Helvetica, sans-serif");
    ...
    viewer.LogoMetrics = LogoMetrics;
})(viewer || (viewer = {}));
var viewer;
(function (viewer) {
...
(function (viewer) {
    ...
    viewer.RasterizedAlphabet = RasterizedAlphabet;
    var RasterBounds = /** @class */ (function () {
        function RasterBounds() {
        }
        return RasterBounds;
    }());
    viewer.RasterBounds = RasterBounds;
})(viewer || (viewer = {}));
var viewer;
(function (viewer) {
